...
# if no corners were found, exit the program
if corners is None:
    print("Could not detect the four corners of the document.")
    print("Please try a different image with better lighting and contrast.")
    exit(1)
